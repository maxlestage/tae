...
export const TEAS: TeaSachet[] = [
  ...
  {
    id: "tropical",
    name: { fr: "Tropical", en: "Tropical Fruit", es: "Frutas Tropicales" },
    description: {
      fr: "Thé noir et fruits exotiques ensoleillés.",
      en: "Black tea and sunny exotic fruits.",
      es: "Té negro y frutas exóticas soleadas.",
    },
    typeKey: "blackTeaFlavored",
    family: "Jaune",
  ...
  {
    id: "peach-mango",
    name: { fr: "Pêche Mangue", en: "Peach Mango", es: "Melocotón Mango" },
    description: {
      fr: "Thé noir, pêche et mangue juteuses.",
      en: "Black tea, juicy peach and mango.",
      es: "Té negro, melocotón y mango jugosos.",
    },
    typeKey: "blackTeaFlavored",
    family: "Jaune",
  ...
  {
    id: "vanilla-caramel",
    name: { fr: "Vanille Caramel", en: "Vanilla Caramel", es: "Vainilla Caramelo" },
    description: {
      fr: "Thé noir, vanille et caramel gourmands.",
      en: "Black tea, indulgent vanilla and caramel.",
      es: "Té negro, vainilla y caramelo golosos.",
    },
    typeKey: "blackTeaFlavored",
    family: "Jaune",
  ...
  },
  {
    ...
    name: { fr: "Mûre Myrtille", en: "Blackberry Blueberry", es: "Mora Arándano" },
    description: {
      fr: "Thé noir, mûre et myrtille des bois.",
      en: "Black tea, blackberry and blueberry.",
      es: "Té negro, mora y arándano.",
    },
    typeKey: "blackTeaFlavored",
    family: "Jaune",
    colors: ["#ffe105", "#5e2a84"],
  ...
  {
    id: "citrus-black",
    name: { fr: "Agrumes", en: "Citrus", es: "Cítricos" },
    description: {
      fr: "Thé noir et agrumes frais et zestés.",
      en: "Black tea and fresh zesty citrus.",
      es: "Té negro y cítricos frescos.",
    },
    typeKey: "blackTeaFlavored",
    family: "Jaune",
    colors: ["#ffe105", "#f5a623"],
  ...
  {
    id: "linden",
    name: { fr: "Tilleul", en: "Linden", es: "Tilo" },
    description: {
      fr: "Tilleul doux, infusion apaisante du soir.",
      en: "Gentle linden, a soothing evening infusion.",
      es: "Tilo suave, infusión calmante de la noche.",
    },
    typeKey: "infusion",
    family: "Ambre",
  ...
  // === Vert — thés verts + infusions (suite) ===
  {
    id: "goji-blueberry",
    name: {
      fr: "Thé Vert Goji Myrtille",
      en: "Green Tea Goji Blueberry",
      es: "Té Verde Goji Arándano",
    },
    description: {
      fr: "Thé vert, baies de goji et myrtille.",
      en: "Green tea, goji berries and blueberry.",
      es: "Té verde, bayas de goji y arándano.",
    },
    typeKey: "greenTeaFlavored",
    family: "Vert",
  ...
  },
  {
    id: "jasmine-petals",
    name: {
      fr: "Thé Vert Pétales de Jasmin",
      en: "Green Tea Jasmine Petals",
      es: "Té Verde Pétalos de Jazmín",
    },
    description: {
      fr: "Thé vert délicat aux pétales de jasmin.",
      en: "Delicate green tea with jasmine petals.",
      es: "Té verde delicado con pétalos de jazmín.",
    },
    typeKey: "greenTeaFlavored",
    family: "Vert",
  ...
  },
  {
    id: "matcha-japan",
    name: {
      fr: "Thé Vert Matcha du Japon",
      en: "Japanese Matcha Green Tea",
      es: "Té Verde Matcha de Japón",
    },
    description: {
      fr: "Thé vert matcha du Japon, intense et végétal.",
      en: "Japanese matcha green tea, intense and vegetal.",
      es: "Té verde matcha de Japón, intenso y vegetal.",
    },
    typeKey: "greenTea",
    family: "Vert",
  ...
  {
    id: "boost",
    name: { fr: "Thé Vert Boost", en: "Green Tea Boost", es: "Té Verde Boost" },
    description: {
      fr: "Thé vert tonifiant, guarana et agrumes.",
      en: "Energizing green tea, guarana and citrus.",
      es: "Té verde energizante, guaraná y cítricos.",
    },
    typeKey: "greenTeaFlavored",
    family: "Vert",
  ...
  },
  {
    id: "jasmine-peach",
    name: {
      fr: "Thé Vert Jasmin Pêche",
      en: "Green Tea Jasmine Peach",
      es: "Té Verde Jazmín Melocotón",
    },
    description: {
      fr: "Thé vert, fleur de jasmin et pêche.",
      en: "Green tea, jasmine flower and peach.",
      es: "Té verde, flor de jazmín y melocotón.",
    },
    typeKey: "greenTeaFlavored",
    family: "Vert",
